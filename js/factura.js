...
function crearFactura(fecha_actual, cliente_actual, vendedor_actual, isCredito, lista_de_compras) {
    let nuevaFactura;
    let listaDeComprasCopia = [...lista_de_compras]; 
    if(facturas.length == 0){
        nuevaFactura = new factura(0, fecha_actual, cliente_actual, vendedor_actual, isCredito, listaDeComprasCopia, calcularTotal()) 
    }
    else{
        let calcularID = facturas[facturas.length-1].id+1
        nuevaFactura = new factura(calcularID, fecha_actual, cliente_actual, vendedor_actual, isCredito, listaDeComprasCopia, calcularTotal()) 
    }    
